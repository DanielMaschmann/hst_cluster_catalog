...
# get target list and sort the targets with distance
...
for target in target_list:
    ...
    print('target ', target)
    cluster_class_c12 = catalog_access.get_hst_cc_class_ml_vgg(target=target, classify='ml')
    cluster_class_qual_c12 = catalog_access.get_hst_cc_class_ml_vgg_qual(target=target, classify='ml')
    color_ub_c12 = catalog_access.get_hst_color_ub(target=target, classify='ml')
    color_vi_c12 = catalog_access.get_hst_color_vi(target=target, classify='ml')
    ebv_c12 = catalog_access.get_hst_cc_ebv(target=target, classify='ml')
    age_c12 = catalog_access.get_hst_cc_age(target=target, classify='ml')
    stellar_m_c12 = catalog_access.get_hst_cc_stellar_m(target=target, classify='ml')
    ci_c12 = catalog_access.get_hst_cc_ci(target=target, classify='ml')
    vi_mod_c12, ub_mod_c12 = scale_reddening_vector(ebv_c12, 0.43, 0.3)

    cluster_class_c3 = catalog_access.get_hst_cc_class_ml_vgg(target=target, classify='ml', cluster_class='class3')
    cluster_class_qual_c3 = catalog_access.get_hst_cc_class_ml_vgg_qual(target=target, classify='ml', cluster_class='class3')
    color_ub_c3 = catalog_access.get_hst_color_ub(target=target, classify='ml', cluster_class='class3')
    color_vi_c3 = catalog_access.get_hst_color_vi(target=target, classify='ml', cluster_class='class3')
    ebv_c3 = catalog_access.get_hst_cc_ebv(target=target, classify='ml', cluster_class='class3')
    age_c3 = catalog_access.get_hst_cc_age(target=target, classify='ml', cluster_class='class3')
    stellar_m_c3 = catalog_access.get_hst_cc_stellar_m(target=target, classify='ml', cluster_class='class3')
    ci_c3 = catalog_access.get_hst_cc_ci(target=target, classify='ml', cluster_class='class3')
    ...
    cluster_class_qual = np.concatenate([cluster_class_qual, cluster_class_qual_c12, cluster_class_qual_c3])
...
print('good_cluster_classification ', sum(cluster_class_qual >= 0.9))
class_1 = cluster_class == 1
class_2 = cluster_class == 2
class_3 = cluster_class == 3
good_class = cluster_class_qual >= 0.9


good_data = (color_vi > -1) & (color_vi < 2.5) & (color_ub > -2.3) & (color_ub < 1.5) & good_class
...
plt.savefig('plot_output/de_reddening_group_ml.png')
