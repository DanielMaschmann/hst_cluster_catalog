...
def get_image_data(galaxy_name, n_bins=250, add_side_pixel_frac=0.03, kernel_size_prop=0.02):
...
def plot_panels(ax_img_r, ax_img_g, ax_img_b, ax_img_rgb, ax_img_hst, img_r, img_g, img_b, img_rgb, img_hst,
                contour_data, contour_borders, contour_color='gold', alpha=1.0, linewidths=4):
...
def plot_names(ax_img_r, ax_img_g, ax_img_b, ax_img_hst, shape, target, fontsize, plot_identifier=True):
    ...
    ax_img_r.set_title(target_name_str, fontsize=fontsize + 20)
    ...
    ax_img_g.text(shape[0]*0.04, shape[1]*0.96, 'Middle Aged Clusters (ML)', color='tab:green',
                  horizontalalignment='left', verticalalignment='top', fontsize=fontsize + 3)

    ax_img_b.text(shape[0]*0.04, shape[1]*0.96, r'Young Clusters (ML) ', color='tab:blue',
                  horizontalalignment='left', verticalalignment='top', fontsize=fontsize + 3)
    ax_img_b.text(shape[0]*0.98, shape[1]*0.96, r' + ALMA ', color='k',
                  horizontalalignment='right', verticalalignment='top', fontsize=fontsize + 3)
...
for index in range(10):
    ...
    figure = plt.figure(figsize=(50, 60))
    ...
    ax_img_hst_1 = figure.add_axes([ax_vertical1, ax_horizont5, ax_size, ax_size], projection=wcs_hist_1)
    ...
    ax_img_hst_2 = figure.add_axes([ax_vertical2, ax_horizont5, ax_size, ax_size], projection=wcs_hist_2)
    ...
    if index != 9:
        ...
        ax_img_hst_3 = figure.add_axes([ax_vertical3, ax_horizont5, ax_size, ax_size], projection=wcs_hist_3)
        ...
        ax_img_hst_4 = figure.add_axes([ax_vertical4, ax_horizont5, ax_size, ax_size], projection=wcs_hist_4)

    plot_panels(ax_img_r=ax_img_gc_1, ax_img_g=ax_img_cascade_1, ax_img_b=ax_img_young_1, ax_img_rgb=ax_img_rgb_1,
                ax_img_hst=ax_img_hst_1,
                img_r=gc_img_1, img_g=cascade_img_1, img_b=young_img_1, img_rgb=rgb_img_1, img_hst=rgb_img_hst_img_1,
                contour_data=alma_data_1, contour_borders=alma_borders_1, contour_color='tab:olive', alpha=0.7, linewidths=4)

    plot_panels(ax_img_r=ax_img_gc_2, ax_img_g=ax_img_cascade_2, ax_img_b=ax_img_young_2, ax_img_rgb=ax_img_rgb_2,
                ax_img_hst=ax_img_hst_2,
                img_r=gc_img_2, img_g=cascade_img_2, img_b=young_img_2, img_rgb=rgb_img_2, img_hst=rgb_img_hst_img_2,
                contour_data=alma_data_2, contour_borders=alma_borders_2, contour_color='tab:olive', alpha=0.7, linewidths=4)
    if index != 9:
        plot_panels(ax_img_r=ax_img_gc_3, ax_img_g=ax_img_cascade_3, ax_img_b=ax_img_young_3, ax_img_rgb=ax_img_rgb_3,
                    ax_img_hst=ax_img_hst_3,
                    img_r=gc_img_3, img_g=cascade_img_3, img_b=young_img_3, img_rgb=rgb_img_3, img_hst=rgb_img_hst_img_3,
                    contour_data=alma_data_3, contour_borders=alma_borders_3, contour_color='tab:olive', alpha=0.7, linewidths=4)

        plot_panels(ax_img_r=ax_img_gc_4, ax_img_g=ax_img_cascade_4, ax_img_b=ax_img_young_4, ax_img_rgb=ax_img_rgb_4,
                    ax_img_hst=ax_img_hst_4,
                    img_r=gc_img_4, img_g=cascade_img_4, img_b=young_img_4, img_rgb=rgb_img_4, img_hst=rgb_img_hst_img_4,
                    contour_data=alma_data_4, contour_borders=alma_borders_4, contour_color='tab:olive', alpha=0.7, linewidths=4)
    ...
    if index != 9:
        ...
        plot_names(ax_img_r=ax_img_gc_4, ax_img_g=ax_img_cascade_4, ax_img_b=ax_img_young_4,
                   ax_img_hst=ax_img_hst_4, target=target_4, shape=gc_img_4.shape, fontsize=fontsize, plot_identifier=False)
