...
for catalog_version in ['SEDfix_Ha1_inclusiveGCcc_inclusiveGCclass',
    ...
    helper_func.plot_reddening_vect(ax=ax_ebv_hum_1, x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
    ...
    helper_func.plot_reddening_vect(ax=ax_ebv_hum_2, x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
                           x_color_int=vi_int, y_color_int=ub_int, av_val=1,
                           linewidth=4, line_color='k', text=False, fontsize=fontsize)
    helper_func.plot_reddening_vect(ax=ax_ebv_hum_3, x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
                           x_color_int=vi_int, y_color_int=ub_int, av_val=1,
                           linewidth=4, line_color='k', text=False, fontsize=fontsize)

    helper_func.plot_reddening_vect(ax=ax_ebv_ml_1, x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
                           x_color_int=vi_int, y_color_int=ub_int, av_val=1,
                           linewidth=4, line_color='k', text=False, fontsize=fontsize-4, x_text_offset=-0.1, y_text_offset=-0.3)
    helper_func.plot_reddening_vect(ax=ax_ebv_ml_2, x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
                           x_color_int=vi_int, y_color_int=ub_int, av_val=1,
                           linewidth=4, line_color='k', text=False, fontsize=fontsize)
    helper_func.plot_reddening_vect(ax=ax_ebv_ml_3, x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
                           x_color_int=vi_int, y_color_int=ub_int, av_val=1,
                           linewidth=4, line_color='k', text=False, fontsize=fontsize)
    ...
    plt.tight_layout()
    plt.savefig('plot_output/color_color_ebv_%s.png' % catalog_version)
    plt.savefig('plot_output/color_color_ebv_%s.pdf' % catalog_version)
    plt.clf()
    plt.cla()
