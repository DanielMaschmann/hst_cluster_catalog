...
def plot_names(ax_img_r, ax_img_g, ax_img_b, ax_img_hst, shape, target, fontsize, plot_identifier=True):
    ...
    ax_img_hst.text(0.97, 0.97, target_name_str, horizontalalignment='right', verticalalignment='top',
                    color='white', fontsize=fontsize, transform=ax_img_hst.transAxes, path_effects=pe)
...
figure = plt.figure(figsize=(60, 45))
...
ax_img_hst_1 = figure.add_axes([ax_vertical1, ax_horizont1, ax_size, ax_size], projection=wcs_hist_1)
ax_img_gc_1 = figure.add_axes([ax_vertical2, ax_horizont1, ax_size, ax_size], projection=wcs_hist_1)
ax_img_cascade_1 = figure.add_axes([ax_vertical3, ax_horizont1, ax_size, ax_size], projection=wcs_hist_1)
ax_img_young_1 = figure.add_axes([ax_vertical4, ax_horizont1, ax_size, ax_size], projection=wcs_hist_1)

ax_img_hst_2 = figure.add_axes([ax_vertical1, ax_horizont2, ax_size, ax_size], projection=wcs_hist_2)
ax_img_gc_2 = figure.add_axes([ax_vertical2, ax_horizont2, ax_size, ax_size], projection=wcs_hist_2)
ax_img_cascade_2 = figure.add_axes([ax_vertical3, ax_horizont2, ax_size, ax_size], projection=wcs_hist_2)
ax_img_young_2 = figure.add_axes([ax_vertical4, ax_horizont2, ax_size, ax_size], projection=wcs_hist_2)

ax_img_hst_3 = figure.add_axes([ax_vertical1, ax_horizont3, ax_size, ax_size], projection=wcs_hist_3)
ax_img_gc_3 = figure.add_axes([ax_vertical2, ax_horizont3, ax_size, ax_size], projection=wcs_hist_3)
ax_img_cascade_3 = figure.add_axes([ax_vertical3, ax_horizont3, ax_size, ax_size], projection=wcs_hist_3)
ax_img_young_3 = figure.add_axes([ax_vertical4, ax_horizont3, ax_size, ax_size], projection=wcs_hist_3)
...
plot_panels(ax_img_r=ax_img_gc_2, ax_img_g=ax_img_cascade_2, ax_img_b=ax_img_young_2,
            ...
            contour_data=alma_data_2, contour_borders=alma_borders_2, plot_contours=plot_contours, contour_color='magenta', alpha=0.7, linewidths=4)
plot_panels(ax_img_r=ax_img_gc_3, ax_img_g=ax_img_cascade_3, ax_img_b=ax_img_young_3,
            ...
            contour_data=alma_data_3, contour_borders=alma_borders_3, plot_contours=plot_contours, contour_color='magenta', alpha=0.7, linewidths=4)


plot_names(ax_img_r=ax_img_gc_1, ax_img_g=ax_img_cascade_1, ax_img_b=ax_img_young_1,
           ax_img_hst=ax_img_hst_1, target=target_1, shape=gc_img_1.shape, fontsize=fontsize, plot_identifier=True)
plot_names(ax_img_r=ax_img_gc_2, ax_img_g=ax_img_cascade_2, ax_img_b=ax_img_young_2,
       ax_img_hst=ax_img_hst_2, target=target_2, shape=gc_img_2.shape, fontsize=fontsize, plot_identifier=False)
plot_names(ax_img_r=ax_img_gc_3, ax_img_g=ax_img_cascade_3, ax_img_b=ax_img_young_3,
       ax_img_hst=ax_img_hst_3, target=target_3, shape=gc_img_3.shape, fontsize=fontsize, plot_identifier=False)
...
plotting_tools.arr_axis_params(ax=ax_img_gc_1, ra_tick_label=True, dec_tick_label=False,
                                   ra_axis_label=' ', dec_axis_label=' ',
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='k',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_1)
plotting_tools.arr_axis_params(ax=ax_img_cascade_1, ra_tick_label=True, dec_tick_label=False,
                                   ra_axis_label=' ', dec_axis_label=' ',
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='k',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_1)
plotting_tools.arr_axis_params(ax=ax_img_young_1, ra_tick_label=True, dec_tick_label=False,
                                   ra_axis_label=' ', dec_axis_label=' ',
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='k',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_1)
...
plotting_tools.arr_axis_params(ax=ax_img_gc_2, ra_tick_label=True, dec_tick_label=False,
                                   ra_axis_label=' ', dec_axis_label=' ',
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='k',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_2)
plotting_tools.arr_axis_params(ax=ax_img_cascade_2, ra_tick_label=True, dec_tick_label=False,
                                   ra_axis_label=' ', dec_axis_label=' ',
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='k',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_2)
plotting_tools.arr_axis_params(ax=ax_img_young_2, ra_tick_label=True, dec_tick_label=False,
                                   ra_axis_label=' ', dec_axis_label=' ',
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='k',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_2)
...
plotting_tools.arr_axis_params(ax=ax_img_hst_3, ra_tick_label=True, dec_tick_label=True,
                                   ...
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='white',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_3)
plotting_tools.arr_axis_params(ax=ax_img_gc_3, ra_tick_label=True, dec_tick_label=False,
                                   ra_axis_label='R.A. (2000.0)', dec_axis_label=' ',
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='k',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_3)
plotting_tools.arr_axis_params(ax=ax_img_cascade_3, ra_tick_label=True, dec_tick_label=False,
                                   ra_axis_label='R.A. (2000.0)', dec_axis_label=' ',
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='k',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_3)
plotting_tools.arr_axis_params(ax=ax_img_young_3, ra_tick_label=True, dec_tick_label=False,
                                   ra_axis_label='R.A. (2000.0)', dec_axis_label=' ',
                                   ra_minpad=0.3, dec_minpad=0.5, tick_color='k',
                                   fontsize=fontsize, labelsize=fontsize, ra_tick_num=3, dec_tick_num=dec_tick_num_3)
...
plt.savefig('plot_output/spatial_dist_panel_flocc.png')
