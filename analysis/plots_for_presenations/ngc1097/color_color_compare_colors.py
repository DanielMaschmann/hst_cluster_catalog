...
fig, ax = plt.subplots(ncols=3, nrows=1, sharex='all', sharey='row', figsize=(35, 15))
fontsize = 40

hf.density_with_points(ax=ax[0], x=color_vi_hum[mask_class_1_hum * mask_good_colors_ubvi_hum],
...
hf.density_with_points(ax=ax[1], x=color_vi_hum[mask_class_2_hum * mask_good_colors_ubvi_hum],
                    y=color_ub_hum[mask_class_2_hum * mask_good_colors_ubvi_hum],
                    binx=np.linspace(x_lim_vi[0], x_lim_vi[1], n_bins),
                    biny=np.linspace(y_lim_ub[1], y_lim_ub[0], n_bins),
                    kernel_std=kernal_std, cmap='inferno', scatter_size=30, scatter_alpha=0.3)
hf.density_with_points(ax=ax[2], x=color_vi_hum[mask_class_3_hum * mask_good_colors_ubvi_hum],
...
hf.plot_reddening_vect(ax=ax[0], x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
                       ...
                       x_text_offset=-0.1, y_text_offset=-0.1)
...
hf.plot_reddening_vect(ax=ax[2], x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
                       x_color_int=vi_int, y_color_int=ub_int, av_val=1,
                       linewidth=4, line_color='k', text=False, fontsize=fontsize)

display_models(ax=ax[0], age_label_fontsize=fontsize+2, y_color='ub', label_sol=r'BC03, Z$_{\odot}$', label_sol50=r'BC03, Z$_{\odot}/50\,(> 500\,{\rm Myr})$')
display_models(ax=ax[1], age_label_fontsize=fontsize+2, y_color='ub')
display_models(ax=ax[2], age_label_fontsize=fontsize+2, y_color='ub', age_labels=True)
...
ax[1].text(-0.4, 2.8, 'Smoothing', horizontalalignment='left', verticalalignment='center', fontsize=fontsize)

ax[0].text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.05, y_lim_ub[0] + (y_lim_ub[1]-y_lim_ub[0])*0.18,
              'N=%i' % (sum(mask_class_1_hum * mask_good_colors_ubvi_hum)),
              horizontalalignment='left', verticalalignment='center', fontsize=fontsize)
ax[1].text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.05, y_lim_ub[0] + (y_lim_ub[1]-y_lim_ub[0])*0.05,
              'N=%i' % (sum(mask_class_2_hum * mask_good_colors_ubvi_hum)),
              horizontalalignment='left', verticalalignment='center', fontsize=fontsize)
ax[2].text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.05, y_lim_ub[0] + (y_lim_ub[1]-y_lim_ub[0])*0.05,
              'N=%i' % (sum(mask_class_3_hum * mask_good_colors_ubvi_hum)),
              horizontalalignment='left', verticalalignment='center', fontsize=fontsize)


ax[0].legend(frameon=False, loc=3, #bbox_to_anchor=(0, 0.05),
                fontsize=fontsize-2)

ax[0].set_title('Class 1 (Human) \n Symmetric Clusters', fontsize=fontsize)
ax[1].set_title('Class 2 (Human) \n Asymmetric Clusters', fontsize=fontsize)
ax[2].set_title('Class 3 (Human) \n Compact Associations', fontsize=fontsize)
...
ax[0].set_ylabel('U (F336W) - B (F438W/F435W'+'$^*$'+')',labelpad=27, fontsize=fontsize)
...
fig.subplots_adjust(left=0.07, bottom=0.09, right=0.995, top=0.91, wspace=0.01, hspace=0.01)
# plt.tight_layout()
