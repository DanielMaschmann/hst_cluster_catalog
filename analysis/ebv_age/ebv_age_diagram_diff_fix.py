...
for catalog_version in ['SEDfix_Ha1_inclusiveGCcc_inclusiveGCclass',
    ...
    fig_hum.savefig('plot_output/age_ebv_hum_1_%s.png' % catalog_version, bbox_inches='tight', dpi=300)
    # fig_hum.savefig('plot_output/age_ebv_hum_1.pdf', bbox_inches='tight', dpi=300)

    fig_ml.subplots_adjust(wspace=0, hspace=0)
    fig_ml.savefig('plot_output/age_ebv_ml_1_%s.png' % catalog_version, bbox_inches='tight', dpi=300)
    ...
    # plt.tight_layout()
    fig_hum.subplots_adjust(wspace=0, hspace=0)
    fig_hum.savefig('plot_output/age_ebv_hum_2_%s.png' % catalog_version, bbox_inches='tight', dpi=300)
    # fig_hum.savefig('plot_output/age_ebv_hum_2.pdf', bbox_inches='tight', dpi=300)

    fig_ml.subplots_adjust(wspace=0, hspace=0)
    fig_ml.savefig('plot_output/age_ebv_ml_2_%s.png' % catalog_version, bbox_inches='tight', dpi=300)
