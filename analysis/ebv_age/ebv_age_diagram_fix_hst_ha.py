...
fig_hum.savefig('plot_output/age_ebv_hum_hst_ha_c123.png', bbox_inches='tight', dpi=300)
fig_hum.savefig('plot_output/age_ebv_hum_hst_ha_c123.pdf', bbox_inches='tight', dpi=300)

fig_ml.subplots_adjust(left=0.13, bottom=0.11, right=0.995, top=0.995, wspace=0.01, hspace=0.01)
fig_ml.savefig('plot_output/age_ebv_ml_hst_ha_c123.png', bbox_inches='tight', dpi=300)
fig_ml.savefig('plot_output/age_ebv_ml_hst_ha_c123.pdf', bbox_inches='tight', dpi=300)
