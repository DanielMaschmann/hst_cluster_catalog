...
for threshold_fact in [2, 3, 4, 5, 6, 7, 8, 9, 10]:
    ...
    ax[0, 2].text(x_lim_ubvi[0] + (x_lim_ubvi[1]-x_lim_ubvi[0])*0.95, y_lim_ubvi[0] + (y_lim_ubvi[1]-y_lim_ubvi[0])*0.93,
                  'Stellar associations (Hum)', horizontalalignment='right', verticalalignment='center', fontsize=fontsize)
    ...
    ax[1, 2].text(x_lim_ubvi[0] + (x_lim_ubvi[1]-x_lim_ubvi[0])*0.95, y_lim_ubvi[0] + (y_lim_ubvi[1]-y_lim_ubvi[0])*0.93,
                  'Stellar associations (ML)', horizontalalignment='right', verticalalignment='center', fontsize=fontsize)
    ...
    plt.tight_layout()
    plt.savefig('plot_output/parametrize_ubvi_thr_fact_%i.png' % threshold_fact)
    plt.cla()
