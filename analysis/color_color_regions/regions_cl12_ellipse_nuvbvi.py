...
gauss_dict_nuvbvi_ml_12 = helper_func.calc_seg(x_data=color_vi_ml[mask_class_12_ml * mask_good_colors_nuvbvi_ml],
                                             y_data=color_nuvb_ml[mask_class_12_ml * mask_good_colors_nuvbvi_ml],
                                             x_data_err=color_vi_err_ml[mask_class_12_ml * mask_good_colors_nuvbvi_ml],
                                             y_data_err=color_nuvb_err_ml[mask_class_12_ml * mask_good_colors_nuvbvi_ml],
                                             x_lim=x_lim_vi, y_lim=y_lim_nuvb, n_bins=n_bins_nuvbvi,
                                             threshold_fact=threshold_fact, kernal_std=kernal_std, contrast=contrast)

np.save('data_output/gauss_dict_nuvbvi_hum_12.npy', gauss_dict_nuvbvi_hum_12)
np.save('data_output/gauss_dict_nuvbvi_ml_12.npy', gauss_dict_nuvbvi_ml_12)

gauss_map_hum_12 = gauss_dict_nuvbvi_hum_12['gauss_map']
seg_map_hum_12 = gauss_dict_nuvbvi_hum_12['seg_deb_map']
...
gauss_map_ml_12 = gauss_dict_nuvbvi_ml_12['gauss_map']
seg_map_ml_12 = gauss_dict_nuvbvi_ml_12['seg_deb_map']
...
#
# helper_func.plot_reg_map(ax=ax_cc_reg_hum, gauss_map=gauss_dict_nuvbvi_hum_12['gauss_map'], seg_map=gauss_dict_nuvbvi_hum_12['seg_deb_map'], smooth_kernel=kernal_std,
#                          x_lim=x_lim_vi, y_lim=y_lim_nuvb, n_bins=n_bins_nuvbvi)
#
# helper_func.plot_reg_map(ax=ax_cc_reg_ml, gauss_map=gauss_dict_nuvbvi_ml_12['gauss_map'], seg_map=gauss_dict_nuvbvi_ml_12['seg_deb_map'], smooth_kernel=kernal_std,
#                          x_lim=x_lim_vi, y_lim=y_lim_nuvb, n_bins=n_bins_nuvbvi)
#
# plt.show()
#
...
vi_hull_young_hum_12, nuvb_hull_young_hum_12 = helper_func.seg2hull(seg_map_hum_12, x_lim=x_lim_vi, y_lim=y_lim_nuvb,
                                                                  n_bins=n_bins_nuvbvi, seg_index=1, contour_index=0,
                                                                  save_str='nuvbvi_young_hum_12', x_label='vi', y_label='nuvb')
vi_hull_cascade_hum_12, nuvb_hull_cascade_hum_12 = helper_func.seg2hull(seg_map_hum_12, x_lim=x_lim_vi, y_lim=y_lim_nuvb,
                                                                  n_bins=n_bins_nuvbvi, seg_index=2, contour_index=0,
                                                                  save_str='nuvbvi_cascade_hum_12', x_label='vi', y_label='nuvb')
vi_hull_gc_hum_12, nuvb_hull_gc_hum_12 = helper_func.seg2hull(seg_map_hum_12, x_lim=x_lim_vi, y_lim=y_lim_nuvb,
                                                                  n_bins=n_bins_nuvbvi, seg_index=3, contour_index=0,
                                                                  save_str='nuvbvi_gc_hum_12', x_label='vi', y_label='nuvb')

vi_hull_young_ml_12, nuvb_hull_young_ml_12 = helper_func.seg2hull(seg_map_ml_12, x_lim=x_lim_vi, y_lim=y_lim_nuvb,
                                                                  n_bins=n_bins_nuvbvi, seg_index=1, contour_index=0,
                                                                  save_str='nuvbvi_young_ml_12', x_label='vi', y_label='nuvb')
vi_hull_cascade_ml_12, nuvb_hull_cascade_ml_12 = helper_func.seg2hull(seg_map_ml_12, x_lim=x_lim_vi, y_lim=y_lim_nuvb,
                                                                  n_bins=n_bins_nuvbvi, seg_index=2, contour_index=0,
                                                                  save_str='nuvbvi_cascade_ml_12', x_label='vi', y_label='nuvb')
# vi_hull_gc_ml_12, nuvb_hull_gc_ml_12 = helper_func.seg2hull(seg_map_ml_12, x_lim=x_lim_vi, y_lim=y_lim_nuvb,
#                                                                   n_bins=n_bins_nuvbvi, seg_index=3, contour_index=0,
#                                                                   save_str='nuvbvi_gc_ml_12', x_label='vi', y_label='nuvb')

hull_nuvbvi_young_hum_12 = ConvexHull(np.array([vi_hull_young_hum_12, nuvb_hull_young_hum_12]).T)
hull_nuvbvi_cascade_hum_12 = ConvexHull(np.array([vi_hull_cascade_hum_12, nuvb_hull_cascade_hum_12]).T)
hull_nuvbvi_gc_hum_12 = ConvexHull(np.array([vi_hull_gc_hum_12, nuvb_hull_gc_hum_12]).T)
hull_nuvbvi_young_ml_12 = ConvexHull(np.array([vi_hull_young_ml_12, nuvb_hull_young_ml_12]).T)
hull_nuvbvi_cascade_ml_12 = ConvexHull(np.array([vi_hull_cascade_ml_12, nuvb_hull_cascade_ml_12]).T)
# hull_nuvbvi_gc_ml_12 = ConvexHull(np.array([vi_hull_gc_ml_12, nuvb_hull_gc_ml_12]).T)

in_hull_young_hum_12 = helper_func.points_in_hull(np.array([color_vi_hum, color_nuvb_hum]).T, hull_nuvbvi_young_hum_12)
in_hull_cascade_hum_12 = helper_func.points_in_hull(np.array([color_vi_hum, color_nuvb_hum]).T, hull_nuvbvi_cascade_hum_12)
in_hull_gc_hum_12 = helper_func.points_in_hull(np.array([color_vi_hum, color_nuvb_hum]).T, hull_nuvbvi_gc_hum_12)
in_hull_young_ml_12 = helper_func.points_in_hull(np.array([color_vi_ml, color_nuvb_ml]).T, hull_nuvbvi_young_ml_12)
in_hull_cascade_ml_12 = helper_func.points_in_hull(np.array([color_vi_ml, color_nuvb_ml]).T, hull_nuvbvi_cascade_ml_12)
# in_hull_gc_ml_12 = helper_func.points_in_hull(np.array([color_vi_ml, color_nuvb_ml]).T, hull_nuvbvi_gc_ml_12)


# bins
n_bins_uncertainty_nuvbvi = 50
x_bins = np.linspace(x_lim_vi[0], x_lim_vi[1], n_bins_uncertainty_nuvbvi)
y_bins = np.linspace(y_lim_nuvb[1], y_lim_nuvb[0], n_bins_uncertainty_nuvbvi)
threshold_hum = 5
threshold_ml = 5
...
snr_nuvb_map_hum = np.zeros((len(x_bins), len(y_bins))) * np.nan
snr_nuvb_map_ml = np.zeros((len(x_bins), len(y_bins))) * np.nan
...
for x_index in range(len(x_bins)-1):
    for y_index in range(len(y_bins)-1):
        mask_in_bin_hum = ((color_vi_hum > x_bins[x_index]) & (color_vi_hum < x_bins[x_index + 1]) &
                           (color_nuvb_hum > y_bins[y_index]) & (color_nuvb_hum < y_bins[y_index + 1]))
        mask_in_bin_ml = ((color_vi_ml > x_bins[x_index]) & (color_vi_ml < x_bins[x_index + 1]) &
                          (color_nuvb_ml > y_bins[y_index]) & (color_nuvb_ml < y_bins[y_index + 1]))

        mask_selected_obj_hum = mask_in_bin_hum * mask_class_12_hum * mask_good_colors_nuvbvi_hum
        mask_selected_obj_ml = mask_in_bin_ml * mask_class_12_ml * mask_good_colors_nuvbvi_ml
        ...
        if sum(mask_selected_obj_hum) > threshold_hum:
            ...
            snr_nuvb_map_hum[x_index, y_index] = np.nanmean(color_nuvb_err_hum[mask_selected_obj_hum])
        if sum(mask_selected_obj_ml) > threshold_ml:
            snr_vi_map_ml[x_index, y_index] = np.nanmean(color_vi_err_ml[mask_selected_obj_ml])
            snr_nuvb_map_ml[x_index, y_index] = np.nanmean(color_nuvb_err_ml[mask_selected_obj_ml])
...
cmap_nuvb = matplotlib.cm.get_cmap('cividis')
norm_nuvb = matplotlib.colors.Normalize(vmin=0, vmax=0.5)

ax_cc_sn_vi_hum = figure.add_axes([0.055, 0.515, 0.27, 0.46])
ax_cc_sn_vi_ml = figure.add_axes([0.055, 0.05, 0.27, 0.46])

ax_cc_sn_nuvb_hum = figure.add_axes([0.395, 0.515, 0.27, 0.46])
ax_cc_sn_nuvb_ml = figure.add_axes([0.395, 0.05, 0.27, 0.46])

ax_cc_reg_hum = figure.add_axes([0.725, 0.515, 0.27, 0.46])
ax_cc_reg_ml = figure.add_axes([0.725, 0.05, 0.27, 0.46])

ax_cbar_sn_vi = figure.add_axes([0.33, 0.2, 0.015, 0.6])
ax_cbar_sn_nuvb = figure.add_axes([0.67, 0.2, 0.015, 0.6])


ax_cc_sn_vi_hum.imshow(snr_vi_map_hum.T, origin='lower', extent=(x_lim_vi[0], x_lim_vi[1], y_lim_nuvb[1], y_lim_nuvb[0]),
                       cmap=cmap_vi, norm=norm_vi,  interpolation='nearest', aspect='auto')
ax_cc_sn_vi_ml.imshow(snr_vi_map_ml.T, origin='lower', extent=(x_lim_vi[0], x_lim_vi[1], y_lim_nuvb[1], y_lim_nuvb[0]),
                      cmap=cmap_vi, norm=norm_vi,  interpolation='nearest', aspect='auto')
ax_cc_sn_nuvb_hum.imshow(snr_nuvb_map_hum.T, origin='lower', extent=(x_lim_vi[0], x_lim_vi[1], y_lim_nuvb[1], y_lim_nuvb[0]),
                       cmap=cmap_nuvb, norm=norm_nuvb,  interpolation='nearest', aspect='auto')
ax_cc_sn_nuvb_ml.imshow(snr_nuvb_map_ml.T, origin='lower', extent=(x_lim_vi[0], x_lim_vi[1], y_lim_nuvb[1], y_lim_nuvb[0]),
                      cmap=cmap_nuvb, norm=norm_nuvb,  interpolation='nearest', aspect='auto')


display_models(ax=ax_cc_sn_vi_hum, y_color='nuvb', label_sol=r'BC03, Z$_{\odot}$', label_sol50=r'BC03, Z$_{\odot}/50\,(> 500\,{\rm Myr})$')
display_models(ax=ax_cc_sn_vi_ml, y_color='nuvb')
display_models(ax=ax_cc_sn_nuvb_hum, y_color='nuvb')
display_models(ax=ax_cc_sn_nuvb_ml, y_color='nuvb')
display_models(ax=ax_cc_reg_hum, y_color='nuvb')
display_models(ax=ax_cc_reg_ml, y_color='nuvb')
...
ColorbarBase(ax_cbar_sn_nuvb, orientation='vertical', cmap=cmap_nuvb, norm=norm_nuvb, extend='neither', ticks=None)
ax_cbar_sn_nuvb.set_ylabel(r'$\sigma_{\rm NUV-B}$', labelpad=-4, fontsize=fontsize + 5)
ax_cbar_sn_nuvb.tick_params(axis='both', which='both', width=2, direction='in', right=True, labelright=True, labelsize=fontsize)
...
helper_func.plot_reddening_vect(ax=ax_cc_sn_nuvb_hum, x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
                       x_color_int=vi_int, y_color_int=nuvb_int, av_val=1,
                                x_text_offset=0.05, y_text_offset=-0.05,
                       linewidth=4, line_color='k', text=False, fontsize=fontsize)
helper_func.plot_reddening_vect(ax=ax_cc_sn_nuvb_ml, x_color_1='v', x_color_2='i',  y_color_1='u', y_color_2='b',
                       x_color_int=vi_int, y_color_int=nuvb_int, av_val=1,
                                x_text_offset=0.05, y_text_offset=-0.05,
                       linewidth=4, line_color='k', text=False, fontsize=fontsize)
...
ax_cc_sn_vi_hum.text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.95, y_lim_nuvb[0] + (y_lim_nuvb[1]-y_lim_nuvb[0])*0.93,
              'Class 1|2 (Hum)', horizontalalignment='right', verticalalignment='center', fontsize=fontsize)
ax_cc_sn_vi_ml.text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.95, y_lim_nuvb[0] + (y_lim_nuvb[1]-y_lim_nuvb[0])*0.93,
              'Class 1|2 (ML)', horizontalalignment='right', verticalalignment='center', fontsize=fontsize)
ax_cc_sn_nuvb_hum.text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.95, y_lim_nuvb[0] + (y_lim_nuvb[1]-y_lim_nuvb[0])*0.93,
              'Class 1|2 (Hum)', horizontalalignment='right', verticalalignment='center', fontsize=fontsize)
ax_cc_sn_nuvb_ml.text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.95, y_lim_nuvb[0] + (y_lim_nuvb[1]-y_lim_nuvb[0])*0.93,
              'Class 1|2 (ML)', horizontalalignment='right', verticalalignment='center', fontsize=fontsize)
ax_cc_reg_hum.text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.95, y_lim_nuvb[0] + (y_lim_nuvb[1]-y_lim_nuvb[0])*0.93,
              'Class 1|2 (Hum)', horizontalalignment='right', verticalalignment='center', fontsize=fontsize)
ax_cc_reg_ml.text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.95, y_lim_nuvb[0] + (y_lim_nuvb[1]-y_lim_nuvb[0])*0.93,
              'Class 1|2 (ML)', horizontalalignment='right', verticalalignment='center', fontsize=fontsize)

ax_cc_sn_vi_hum.set_title('Mean V-I uncertainty map', fontsize=fontsize)
ax_cc_sn_nuvb_hum.set_title('Mean NUV-B uncertainty map', fontsize=fontsize)
...
ax_cc_sn_nuvb_hum.set_xlim(x_lim_vi)
ax_cc_sn_nuvb_ml.set_xlim(x_lim_vi)
ax_cc_reg_hum.set_xlim(x_lim_vi)
ax_cc_reg_ml.set_xlim(x_lim_vi)

ax_cc_sn_vi_hum.set_ylim(y_lim_nuvb)
ax_cc_sn_vi_ml.set_ylim(y_lim_nuvb)
ax_cc_sn_nuvb_hum.set_ylim(y_lim_nuvb)
ax_cc_sn_nuvb_ml.set_ylim(y_lim_nuvb)
ax_cc_reg_hum.set_ylim(y_lim_nuvb)
ax_cc_reg_ml.set_ylim(y_lim_nuvb)

ax_cc_reg_hum.set_yticklabels([])
ax_cc_reg_ml.set_yticklabels([])
ax_cc_sn_nuvb_hum.set_yticklabels([])
ax_cc_sn_nuvb_ml.set_yticklabels([])

ax_cc_sn_vi_hum.set_xticklabels([])
ax_cc_sn_nuvb_hum.set_xticklabels([])
...
ax_cc_sn_nuvb_ml.set_xlabel('V (F555W) - I (F814W)', fontsize=fontsize)
...
ax_cc_sn_nuvb_hum.tick_params(axis='both', which='both', width=1.5, length=4, right=True, top=True, direction='in', labelsize=fontsize)
ax_cc_sn_nuvb_ml.tick_params(axis='both', which='both', width=1.5, length=4, right=True, top=True, direction='in', labelsize=fontsize)
...
plt.savefig('plot_output/uncert_reg_c12_nuvbvi.png')
plt.savefig('plot_output/uncert_reg_c12_nuvbvi.pdf')
