...
mask_disc_or_arm = np.array([], dtype=bool)
...
for target in target_list:
    ...
    if not catalog_access.morph_mask_data[galaxy_name]['presence_arm']:
        print('no spiral arms')
        continue
    ...
    class_qual_ml = np.concatenate([class_qual_12_ml, class_qual_3_ml])
    ...
    class_array = np.concatenate([class_array, class_ml])
    class_qual_array = np.concatenate([class_qual_array, class_qual_ml])
    age_array = np.concatenate([age_array, age_ml])
    ...
    mask_disc_or_arm = np.concatenate([mask_disc_or_arm, mask_disc_or_arm_ml])
    ...
    min_dist_array = np.concatenate([min_dist_array, min_dist2arm_array])


# plt.imshow(mask_arm)
# plt.scatter(x_coord_skeleton, y_coord_skeleton)
# plt.scatter(x_pos_pixel_ml[mask_disc_or_arm_ml], y_pos_pixel_ml[mask_disc_or_arm_ml], c=min_dist2arm_array[mask_disc_or_arm_ml])
# plt.show()

young = age_array <= 10
inter = (age_array > 10) & (age_array <= 100)
old = age_array > 100
class_qual = class_qual_array >= 0.9
...
ax[0].hist(min_dist_array[mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), linewidth=2, histtype='step', color='k')
ax[0].hist(min_dist_array[young*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), linewidth=2, histtype='step', color='b', label='age < 10Myr')
ax[0].hist(min_dist_array[inter*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), linewidth=2, histtype='step', color='g', label='10 < age < 100Myr')
ax[0].hist(min_dist_array[old*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), linewidth=2, histtype='step', color='r', label='age > 100Myr')


ax[1].hist(min_dist_array[mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 15), linewidth=2, histtype='step', color='k')
ax[1].hist(min_dist_array[class_1*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 15), linewidth=2, histtype='step', color='r', label='Class 1')
ax[1].hist(min_dist_array[class_2*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 15), linewidth=2, histtype='step', color='g', label='Class 2')
ax[1].hist(min_dist_array[class_3*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 15), linewidth=2, histtype='step', color='b', label='Class 3')
...
ax[0].set_xlabel('Dist. to Arm [kpc]', fontsize=fontsize)
ax[1].set_xlabel('Dist. to Arm [kpc]', fontsize=fontsize)
ax[0].set_ylabel('Counts', fontsize=fontsize)
ax[0].tick_params(axis='both', which='both', width=1.5, length=4, right=True, top=True, direction='in', labelsize=13)
ax[1].tick_params(axis='both', which='both', width=1.5, length=4, right=True, top=True, direction='in', labelsize=13)


plt.savefig('plot_output/arm_distance_log.png')
plt.close()
...
ax[0].hist(min_dist_array[mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), density=True, linewidth=2, histtype='step', color='k')
ax[0].hist(min_dist_array[young*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), density=True, linewidth=2, histtype='step', color='b', label='age < 10Myr')
ax[0].hist(min_dist_array[inter*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), density=True, linewidth=2, histtype='step', color='g', label='10 < age < 100Myr')
ax[0].hist(min_dist_array[old*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), density=True, linewidth=2, histtype='step', color='r', label='age > 100Myr')


ax[1].hist(min_dist_array[mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), density=True, linewidth=2, histtype='step', color='k')
ax[1].hist(min_dist_array[class_1*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), density=True, linewidth=2, histtype='step', color='r', label='Class 1')
ax[1].hist(min_dist_array[class_2*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), density=True, linewidth=2, histtype='step', color='g', label='Class 2')
ax[1].hist(min_dist_array[class_3*mask_disc_or_arm*class_qual], bins=np.linspace(0, 5, 11), density=True, linewidth=2, histtype='step', color='b', label='Class 3')
...
plt.savefig('plot_output/arm_distance_lin.png')
plt.close()
