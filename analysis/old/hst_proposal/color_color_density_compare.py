...
fig, ax = plt.subplots(ncols=4, nrows=2, sharex=True, sharey=True, figsize=(22.3, 13))
fontsize = 17

ax[0, 0].plot(model_vi_sol, model_ub_sol, color='cyan', linewidth=5, linestyle='--', alpha=0.9)
ax[0, 1].plot(model_vi_sol, model_ub_sol, color='cyan', linewidth=5, linestyle='--', alpha=0.9)
ax[0, 2].plot(model_vi_sol, model_ub_sol, color='cyan', linewidth=5, linestyle='--', alpha=0.9)
ax[0, 3].plot(model_vi_sol, model_ub_sol, color='cyan', linewidth=5, linestyle='--', alpha=0.9)

ax[1, 0].plot(model_vi_sol, model_ub_sol, color='cyan', linewidth=5, linestyle='--', alpha=0.9)
ax[1, 1].plot(model_vi_sol, model_ub_sol, color='cyan', linewidth=5, linestyle='--', alpha=0.9)
ax[1, 2].plot(model_vi_sol, model_ub_sol, color='cyan', linewidth=5, linestyle='--', alpha=0.9)
ax[1, 3].plot(model_vi_sol, model_ub_sol, color='cyan', linewidth=5, linestyle='--', alpha=0.9)


density_with_points(ax=ax[0, 0], x=color_vi_hum[mask_class_1_hum * mask_good_colors_hum],
                     y=color_ub_hum[mask_class_1_hum * mask_good_colors_hum])
...
kernal_rad = (xedges[1] - xedges[0]) * 2.0
# plot_kernel_std
...
ax[0, 3].set_title('Class 3', fontsize=fontsize)
...
plt.tight_layout()
fig.savefig('plot_output/ub_vi_compare_density_g.png')
fig.savefig('plot_output/ub_vi_compare_density_g.pdf')
fig.clf()
plt.close()
