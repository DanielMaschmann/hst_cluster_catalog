...
for index in range(0, 20):
    ...
    h_alpha_coverage = (h_alpha_intensity_hum_3 > 3) & (hii_reg_hum_3 > 0)
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h3_hum_1.png', bbox_inches='tight', dpi=300)
# fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h3_hum_1.pdf', bbox_inches='tight', dpi=300)
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h3_hum_2.png', bbox_inches='tight', dpi=300)
# fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h3_hum_2.pdf', bbox_inches='tight', dpi=300)
