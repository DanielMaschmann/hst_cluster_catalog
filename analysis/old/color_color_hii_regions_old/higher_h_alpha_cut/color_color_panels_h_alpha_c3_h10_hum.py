...
for index in range(0, 20):
    ...
    h_alpha_coverage = (h_alpha_intensity_hum_3 > 10) & (hii_reg_hum_3 > 0)
    ...
    ax[row_index, col_index].scatter(color_vi_hum_3[(cluster_class_hum_3 == 3) & ~h_alpha_coverage],
                                     color_ub_hum_3[(cluster_class_hum_3 == 3) & ~h_alpha_coverage],
                                     c='silver', s=10)
    ax[row_index, col_index].scatter(color_vi_hum_3[(cluster_class_hum_3 == 3) & h_alpha_coverage],
                                     color_ub_hum_3[(cluster_class_hum_3 == 3) & h_alpha_coverage],
                                     c=h_alpha_intensity_hum_3[(cluster_class_hum_3 == 3) & h_alpha_coverage],
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h10_hum_1.png', bbox_inches='tight', dpi=300)
# fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h10_hum_1.pdf', bbox_inches='tight', dpi=300)
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h10_hum_2.png', bbox_inches='tight', dpi=300)
# fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h10_hum_2.pdf', bbox_inches='tight', dpi=300)
