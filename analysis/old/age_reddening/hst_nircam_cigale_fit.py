...
target = 'ngc0628c'
band_list = ['F275W', 'F336W', 'F435W', 'F555W', 'F814W', 'F200W', 'F300M', 'F335M', 'F360M']
...
phangs_photometry = AnalysisTools(hst_data_path='/home/benutzer/data/PHANGS-HST',
                                  ...
                                  miri_data_ver='v0p5')
# load all data
phangs_photometry.load_hst_nircam_miri_bands(flux_unit='mJy', band_list=band_list)
...
flux_dict = {'n_obj': 1,
             ...
             'flux_F275W_err': [aperture_dict['aperture_dict_F275W']['flux_err']],
             'flux_F336W': [aperture_dict['aperture_dict_F336W']['flux']],
             'flux_F336W_err': [aperture_dict['aperture_dict_F336W']['flux_err']],
             'flux_F435W': [aperture_dict['aperture_dict_F435W']['flux']],
             'flux_F435W_err': [aperture_dict['aperture_dict_F435W']['flux_err']],
             'flux_F555W': [aperture_dict['aperture_dict_F555W']['flux']],
             'flux_F555W_err': [aperture_dict['aperture_dict_F555W']['flux_err']],
             'flux_F814W': [aperture_dict['aperture_dict_F814W']['flux']],
             'flux_F814W_err': [aperture_dict['aperture_dict_F814W']['flux_err']],
             'flux_F200W': [aperture_dict['aperture_dict_F200W']['flux']],
             'flux_F200W_err': [aperture_dict['aperture_dict_F200W']['flux_err']],
             ...
             'flux_F360M_err': [aperture_dict['aperture_dict_F360M']['flux_err']]}
...
ax_f200w = figure.add_axes([0.02 + 5 * 0.065, 0.71, 0.19, 0.19], projection=cutout_dict['F200W_img_cutout'].wcs)
ax_f300m = figure.add_axes([0.02 + 6 * 0.065, 0.71, 0.19, 0.19], projection=cutout_dict['F300M_img_cutout'].wcs)
ax_f335m = figure.add_axes([0.02 + 7 * 0.065, 0.71, 0.19, 0.19], projection=cutout_dict['F335M_img_cutout'].wcs)
ax_f360m = figure.add_axes([0.02 + 8 * 0.065, 0.71, 0.19, 0.19], projection=cutout_dict['F360M_img_cutout'].wcs)
...
plotting_tools.plot_postage_stamps(ax=ax_f200w, cutout=cutout_dict['F200W_img_cutout'], fontsize=fontsize,
                                   show_ax_label=False, title='F200W')
plotting_tools.plot_postage_stamps(ax=ax_f300m, cutout=cutout_dict['F300M_img_cutout'], fontsize=fontsize,
                                   show_ax_label=False, title='F300M')
plotting_tools.plot_postage_stamps(ax=ax_f335m, cutout=cutout_dict['F335M_img_cutout'], fontsize=fontsize,
                                   show_ax_label=False, title='F335M')
plotting_tools.plot_postage_stamps(ax=ax_f360m, cutout=cutout_dict['F360M_img_cutout'], fontsize=fontsize,
                                   show_ax_label=False, title='F360M')


ax_sed.errorbar(phangs_photometry.get_band_wave(band='F275W'), flux_dict['flux_F275W'][0], yerr=flux_dict['flux_F275W_err'][0],
                fmt='o', c='k', ms=10)
ax_sed.errorbar(phangs_photometry.get_band_wave(band='F336W'), flux_dict['flux_F336W'][0], yerr=flux_dict['flux_F336W_err'][0],
                fmt='o', c='k', ms=10)
ax_sed.errorbar(phangs_photometry.get_band_wave(band='F435W'), flux_dict['flux_F435W'][0], yerr=flux_dict['flux_F435W_err'][0],
                fmt='o', c='k', ms=10)
ax_sed.errorbar(phangs_photometry.get_band_wave(band='F555W'), flux_dict['flux_F555W'][0], yerr=flux_dict['flux_F555W_err'][0],
                fmt='o', c='k', ms=10)
ax_sed.errorbar(phangs_photometry.get_band_wave(band='F814W'), flux_dict['flux_F814W'][0], yerr=flux_dict['flux_F814W_err'][0],
                fmt='o', c='k', ms=10)
ax_sed.errorbar(phangs_photometry.get_band_wave(band='F200W'), flux_dict['flux_F200W'][0], yerr=flux_dict['flux_F200W_err'][0],
                fmt='o', c='k', ms=10)
ax_sed.errorbar(phangs_photometry.get_band_wave(band='F300M'), flux_dict['flux_F300M'][0], yerr=flux_dict['flux_F300M_err'][0],
                fmt='o', c='k', ms=10)
ax_sed.errorbar(phangs_photometry.get_band_wave(band='F335M'), flux_dict['flux_F335M'][0], yerr=flux_dict['flux_F335M_err'][0],
                fmt='o', c='k', ms=10)
ax_sed.errorbar(phangs_photometry.get_band_wave(band='F360M'), flux_dict['flux_F360M'][0], yerr=flux_dict['flux_F360M_err'][0],
                fmt='o', c='k', ms=10)
...
figure.savefig('plot_output/hst_nircam_sed_1.png')
