...
ax[2, 0].text(x_lim_vi[0] + (x_lim_vi[1]-x_lim_vi[0])*0.05, y_lim_ub[0] + (y_lim_ub[1]-y_lim_ub[0])*0.12,
              'ML, V-band cut (faint)', horizontalalignment='left', verticalalignment='center', fontsize=fontsize)
...
fig.savefig('plot_output/ub_vi_compare_density_faint_end.png')
fig.savefig('plot_output/ub_vi_compare_density_faint_end.pdf')
fig.clf()
plt.close()
