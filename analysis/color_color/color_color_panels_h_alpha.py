...
for index in range(0, 20):
    ...
    h_alpha_coverage = h_alpha_intensity_hum_12 > 5
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_1.png', bbox_inches='tight', dpi=300)
fig.savefig('plot_output/ub_vi_h_alpha_panel_1.pdf', bbox_inches='tight', dpi=300)
...
for index in range(20, 39):
    ...
    ax[row_index, col_index].scatter(color_vi_hum_12[(cluster_class_hum_12 == 1) & h_alpha_coverage],
                                     color_ub_hum_12[(cluster_class_hum_12 == 1) & h_alpha_coverage],
                                     c=h_alpha_intensity_hum_12[(cluster_class_hum_12 == 1) & h_alpha_coverage], norm=norm, cmap=cmap, s=50)
    ax[row_index, col_index].scatter(color_vi_hum_12[(cluster_class_hum_12 == 2) & h_alpha_coverage],
                                         color_ub_hum_12[(cluster_class_hum_12 == 2) & h_alpha_coverage],
                                     c=h_alpha_intensity_hum_12[(cluster_class_hum_12 == 2) & h_alpha_coverage], norm=norm, cmap=cmap, s=50)
    ax[row_index, col_index].annotate('', xy=(vi_int + max_color_ext_vi, ub_int + max_color_ext_ub), xycoords='data',
                                      xytext=(vi_int, ub_int), fontsize=fontsize,
                                      textcoords='data', arrowprops=dict(arrowstyle='-|>', color='k', lw=2, ls='-'))
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_2.png', bbox_inches='tight', dpi=300)
fig.savefig('plot_output/ub_vi_h_alpha_panel_2.pdf', bbox_inches='tight', dpi=300)
