...
for threshold_fact in [2, 3, 4, 5, 6, 7, 8, 9, 10]:
    ...
    gauss_dict_ubvi_hum_1 = hf.calc_seg(x_data=color_vi_hum[mask_class_1_hum * mask_good_colors_ubvi_hum],
                                     ...
                                     x_lim=x_lim_vi, y_lim=y_lim_ub, n_bins=n_bins_ubvi, threshold_fact=threshold_fact, kernal_std=kernel_size)
    ...
    gauss_dict_bvvi_hum_1 = hf.calc_seg(x_data=color_vi_hum[mask_class_1_hum * mask_good_colors_bvvi_hum],
                                     ...
                                     x_lim=x_lim_vi, y_lim=y_lim_bv, n_bins=n_bins_bvvi, threshold_fact=threshold_fact, kernal_std=kernel_size)
    ...
    np.save('data_output/gauss_dict_ubvi_hum_1_thresh_%i.npy' % threshold_fact, gauss_dict_ubvi_hum_1)
    np.save('data_output/gauss_dict_ubvi_ml_1_thresh_%i.npy' % threshold_fact, gauss_dict_ubvi_ml_1)
    np.save('data_output/gauss_dict_bvvi_hum_1_thresh_%i.npy' % threshold_fact, gauss_dict_bvvi_hum_1)
    np.save('data_output/gauss_dict_bvvi_ml_1_thresh_%i.npy' % threshold_fact, gauss_dict_bvvi_ml_1)

    # get the hull
    seg_map_ubvi_hum_1 = gauss_dict_ubvi_hum_1['seg_deb_map']
    seg_map_ubvi_ml_1 = gauss_dict_ubvi_ml_1['seg_deb_map']
    seg_map_bvvi_hum_1 = gauss_dict_bvvi_hum_1['seg_deb_map']
    ...
    vi_hull_ubvi_ml_1, ub_hull_ubvi_ml_1 = hf.seg2hull(seg_map_ubvi_ml_1, x_lim=x_lim_vi, y_lim=y_lim_ub,
                                                       n_bins=n_bins_ubvi, seg_index=2, contour_index=0,
                                                       save_str='gc_ubvi_thres%i_ml' % threshold_fact,
                                                       x_label='vi', y_label='ub')
    vi_hull_bvvi_hum_1, bv_hull_bvvi_hum_1 = hf.seg2hull(seg_map_bvvi_hum_1, x_lim=x_lim_vi, y_lim=y_lim_bv,
                                                         n_bins=n_bins_bvvi, seg_index=2, contour_index=0,
                                                         save_str='gc_bvvi_thres%i_hum' % threshold_fact,
                                                         x_label='vi', y_label='bv')
    vi_hull_bvvi_ml_1, bv_hull_bvvi_ml_1 = hf.seg2hull(seg_map_bvvi_ml_1, x_lim=x_lim_vi, y_lim=y_lim_bv,
                                                       n_bins=n_bins_bvvi, seg_index=2, contour_index=0,
                                                       save_str='gc_bvvi_thres%i_ml' % threshold_fact,
                                                       x_label='vi', y_label='bv')
    ...
    hf.plot_reg_map(ax=ax[0, 0], gauss_map=gauss_dict_ubvi_hum_1['gauss_map'], seg_map=gauss_dict_ubvi_hum_1['seg_deb_map'],
                 x_lim=x_lim_vi, y_lim=y_lim_ub, n_bins=n_bins_ubvi, plot_cont_2=True, x_label='vi', y_label='ub', smooth_kernel=kernel_size)
    ...
    hf.plot_reg_map(ax=ax[1, 0], gauss_map=gauss_dict_bvvi_hum_1['gauss_map'], seg_map=gauss_dict_bvvi_hum_1['seg_deb_map'],
                 x_lim=x_lim_vi, y_lim=y_lim_bv, n_bins=n_bins_bvvi, plot_cont_2=True, x_label='vi', y_label='bv', smooth_kernel=kernel_size)
