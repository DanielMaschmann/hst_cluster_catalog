...
x = np.array([color_vi_hum[mask_class_1_hum * mask_good_colors_nuvbvi_hum],
              color_nuvb_hum[mask_class_1_hum * mask_good_colors_nuvbvi_hum]]).T

gm = GaussianMixture(n_components=10).fit(x)
...
ax.set_title('Class 1, Hum', fontsize=15)

ax.set_ylabel('NUV (F275W) - B (F438W/F435W'+'$^*$'+')', fontsize=15)
ax.set_xlabel('V (F555W) - I (F814W)', fontsize=15)

ax.set_xlim(x_lim_vi)
ax.set_ylim(y_lim_nuvb)
ax.tick_params(axis='both', which='both', width=1.5, length=4, right=True, top=True, direction='in', labelsize=15)
plt.savefig('plot_output/gmm.png')
...
vi_hull_mid_nuvbvi_hum_1, nuvb_hull_mid_nuvbvi_hum_1 = helper_func.seg2hull(gauss_dict_nuvbvi_hum_1['seg_deb_map'],
                                                                                x_lim=x_lim_vi, y_lim=y_lim_nuvb,
                                                                                n_bins=n_bins_nuvbvi,
                                                                                seg_index=1, contour_index=0,
                                                                                save_str='nuvbvi_mid_hum_2',
                                                                                x_label='vi', y_label='nuvb')
vi_hull_ogc_nuvbvi_hum_1, nuvb_hull_ogc_nuvbvi_hum_1 = helper_func.seg2hull(gauss_dict_nuvbvi_hum_1['seg_deb_map'],
                                                                                x_lim=x_lim_vi, y_lim=y_lim_nuvb,
                                                                                n_bins=n_bins_nuvbvi,
                                                                                seg_index=2, contour_index=0,
                                                                                save_str='nuvbvi_ogc_hum_2',
                                                                                x_label='vi', y_label='nuvb')
...
vi_hull_mid_nuvbvi_ml_1, nuvb_hull_mid_nuvbvi_ml_1 = helper_func.seg2hull(gauss_dict_nuvbvi_ml_1['seg_deb_map'],
                                                                                x_lim=x_lim_vi, y_lim=y_lim_nuvb,
                                                                                n_bins=n_bins_nuvbvi,
                                                                                seg_index=1, contour_index=0,
                                                                                save_str='nuvbvi_mid_ml_2',
                                                                                x_label='vi', y_label='nuvb')
vi_hull_ogc_nuvbvi_ml_1, nuvb_hull_ogc_nuvbvi_ml_1 = helper_func.seg2hull(gauss_dict_nuvbvi_ml_1['seg_deb_map'],
                                                                                x_lim=x_lim_vi, y_lim=y_lim_nuvb,
                                                                                n_bins=n_bins_nuvbvi,
                                                                                seg_index=2, contour_index=0,
                                                                                save_str='nuvbvi_ogc_ml_2',
                                                                                x_label='vi', y_label='nuvb')
...
vi_hull_mid_ubvi_hum_1, ub_hull_mid_ubvi_hum_1 = helper_func.seg2hull(gauss_dict_ubvi_hum_1['seg_deb_map'],
                                                                                x_lim=x_lim_vi, y_lim=y_lim_ub,
                                                                                n_bins=n_bins_ubvi,
                                                                                seg_index=1, contour_index=0,
                                                                                save_str='ubvi_mid_hum_2',
                                                                                x_label='vi', y_label='ub')
vi_hull_ogc_ubvi_hum_1, ub_hull_ogc_ubvi_hum_1 = helper_func.seg2hull(gauss_dict_ubvi_hum_1['seg_deb_map'],
                                                                                x_lim=x_lim_vi, y_lim=y_lim_ub,
                                                                                n_bins=n_bins_ubvi,
                                                                                seg_index=2, contour_index=0,
                                                                                save_str='ubvi_ogc_hum_2',
                                                                                x_label='vi', y_label='ub')
...
vi_hull_mid_ubvi_ml_1, ub_hull_mid_ubvi_ml_1 = helper_func.seg2hull(gauss_dict_ubvi_ml_1['seg_deb_map'],
                                                                                x_lim=x_lim_vi, y_lim=y_lim_ub,
                                                                                n_bins=n_bins_ubvi,
                                                                                seg_index=1, contour_index=0,
                                                                                save_str='ubvi_mid_ml_2',
                                                                                x_label='vi', y_label='ub')
vi_hull_ogc_ubvi_ml_1, ub_hull_ogc_ubvi_ml_1 = helper_func.seg2hull(gauss_dict_ubvi_ml_1['seg_deb_map'],
                                                                                x_lim=x_lim_vi, y_lim=y_lim_ub,
                                                                                n_bins=n_bins_ubvi,
                                                                                seg_index=2, contour_index=0,
                                                                                save_str='ubvi_ogc_ml_2',
                                                                                x_label='vi', y_label='ub')
...
hull_nuvbvi_mid_hum_1 = ConvexHull(np.array([vi_hull_mid_nuvbvi_hum_1, nuvb_hull_mid_nuvbvi_hum_1]).T)
hull_nuvbvi_ogc_hum_1 = ConvexHull(np.array([vi_hull_ogc_nuvbvi_hum_1, nuvb_hull_ogc_nuvbvi_hum_1]).T)
hull_nuvbvi_young_hum_3 = ConvexHull(np.array([vi_hull_young_nuvbvi_hum_3, nuvb_hull_young_nuvbvi_hum_3]).T)

hull_nuvbvi_mid_ml_1 = ConvexHull(np.array([vi_hull_mid_nuvbvi_ml_1, nuvb_hull_mid_nuvbvi_ml_1]).T)
hull_nuvbvi_ogc_ml_1 = ConvexHull(np.array([vi_hull_ogc_nuvbvi_ml_1, nuvb_hull_ogc_nuvbvi_ml_1]).T)
hull_nuvbvi_young_ml_3 = ConvexHull(np.array([vi_hull_young_nuvbvi_ml_3, nuvb_hull_young_nuvbvi_ml_3]).T)

hull_ubvi_mid_hum_1 = ConvexHull(np.array([vi_hull_mid_ubvi_hum_1, ub_hull_mid_ubvi_hum_1]).T)
hull_ubvi_ogc_hum_1 = ConvexHull(np.array([vi_hull_ogc_ubvi_hum_1, ub_hull_ogc_ubvi_hum_1]).T)
hull_ubvi_young_hum_3 = ConvexHull(np.array([vi_hull_young_ubvi_hum_3, ub_hull_young_ubvi_hum_3]).T)

hull_ubvi_mid_ml_1 = ConvexHull(np.array([vi_hull_mid_ubvi_ml_1, ub_hull_mid_ubvi_ml_1]).T)
hull_ubvi_ogc_ml_1 = ConvexHull(np.array([vi_hull_ogc_ubvi_ml_1, ub_hull_ogc_ubvi_ml_1]).T)
...
helper_func.plot_reg_map(ax=ax[0, 0], gauss_map=gauss_dict_nuvbvi_hum_1['gauss_map'],
                         ...
                         x_lim=x_lim_vi, y_lim=y_lim_nuvb, n_bins=n_bins_nuvbvi)
scale = np.nanmax(gauss_dict_nuvbvi_hum_2['gauss_map'])
ax[0, 1].imshow(convolve(gauss_dict_nuvbvi_hum_2['gauss_map'], kernel), origin='lower',
...
helper_func.plot_reg_map(ax=ax[1, 0], gauss_map=gauss_dict_nuvbvi_ml_1['gauss_map'],
                         ...
                         color_1='Greens', color_2='Reds',
                         x_lim=x_lim_vi, y_lim=y_lim_nuvb, n_bins=n_bins_nuvbvi)
scale = np.nanmax(gauss_dict_nuvbvi_ml_2['gauss_map'])
ax[1, 1].imshow(convolve(gauss_dict_nuvbvi_ml_2['gauss_map'], kernel), origin='lower',
                extent=(x_lim_vi[0], x_lim_vi[1], y_lim_nuvb[1], y_lim_nuvb[0]),
                cmap='Greys', vmin=0, vmax=scale, interpolation='nearest', aspect='auto')
...
helper_func.plot_reg_map(ax=ax[2, 0], gauss_map=gauss_dict_ubvi_hum_1['gauss_map'],
                         ...
                         color_1='Greens', color_2='Reds',
                         x_lim=x_lim_vi, y_lim=y_lim_ub, n_bins=n_bins_ubvi)
scale = np.nanmax(gauss_dict_ubvi_hum_2['gauss_map'])
ax[2, 1].imshow(convolve(gauss_dict_ubvi_hum_2['gauss_map'], kernel), origin='lower',
...
helper_func.plot_reg_map(ax=ax[3, 0], gauss_map=gauss_dict_ubvi_ml_1['gauss_map'],
                         ...
                         color_1='Greens', color_2='Reds',
                         x_lim=x_lim_vi, y_lim=y_lim_ub, n_bins=n_bins_ubvi)
scale = np.nanmax(gauss_dict_ubvi_ml_2['gauss_map'])
ax[3, 1].imshow(convolve(gauss_dict_ubvi_ml_2['gauss_map'], kernel), origin='lower',
                extent=(x_lim_vi[0], x_lim_vi[1], y_lim_ub[1], y_lim_ub[0]),
                cmap='Greys', vmin=0, vmax=scale, interpolation='nearest', aspect='auto')
