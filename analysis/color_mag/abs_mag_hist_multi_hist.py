...
abs_v_band_mag_array_hum_12 = np.array([])
abs_v_band_mag_array_hum_3 = np.array([])
abs_v_band_mag_array_ml_12 = np.array([])
abs_v_band_mag_array_ml_3 = np.array([])
...
for target in target_list:
    ...
    abs_v_band_mag_array_hum_12 = np.concatenate([abs_v_band_mag_array_hum_12, abs_v_mag_hum_12])
    abs_v_band_mag_array_hum_3 = np.concatenate([abs_v_band_mag_array_hum_3, abs_v_mag_hum_3])
    ...
    abs_v_band_mag_array_ml_12 = np.concatenate([abs_v_band_mag_array_ml_12, abs_v_mag_ml_12])
    abs_v_band_mag_array_ml_3 = np.concatenate([abs_v_band_mag_array_ml_3, abs_v_mag_ml_3])
    ...
    ax[0].hist(abs_v_band_mag_array_hum_12, bins=bins, linewidth=1, color='tab:red', histtype='step', alpha=0.7)
    ax[0].hist(abs_v_band_mag_array_ml_12, bins=bins, linewidth=1, color='tab:grey', histtype='step', alpha=0.7)

    ax[1].hist(abs_v_band_mag_array_hum_3, bins=bins, linewidth=1, color='tab:red', histtype='step', alpha=0.7)
    ax[1].hist(abs_v_band_mag_array_ml_3, bins=bins, linewidth=1, color='tab:grey', histtype='step', alpha=0.7)
...
ax[0].hist(abs_v_band_mag_array_ml_12, bins=bins, linewidth=3, color='tab:grey', histtype='step')
ax[0].hist(abs_v_band_mag_array_hum_12, bins=bins, linewidth=3, color='tab:red', histtype='step')

ax[1].hist(abs_v_band_mag_array_ml_3, bins=bins, linewidth=3, color='tab:grey', histtype='step')
ax[1].hist(abs_v_band_mag_array_hum_3, bins=bins, linewidth=3, color='tab:red', histtype='step')
...
ax[0].plot([], [], color='tab:red', linewidth=3, label='Human (N = %i)' % len(abs_v_band_mag_hum))
ax[0].plot([], [], color='tab:grey', linewidth=3, label='ML (N = %i)' % len(abs_v_band_mag_ml))
...
ax[0].set_title('Class 1+2 Clusters', fontsize=fontsize)
ax[1].set_title('Class 3 Compact Associations', fontsize=fontsize)
...
fig.savefig('plot_output/abs_v_mag_hist_new.png', bbox_inches='tight', dpi=300)
fig.savefig('plot_output/abs_v_mag_hist_new.pdf', bbox_inches='tight', dpi=300)
