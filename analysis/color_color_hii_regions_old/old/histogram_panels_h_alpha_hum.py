...
fig.savefig('plot_output/hist_h_alpha_panel_1_medsub.png', bbox_inches='tight', dpi=300)
fig.savefig('plot_output/hist_h_alpha_panel_1_medsub.pdf', bbox_inches='tight', dpi=300)
