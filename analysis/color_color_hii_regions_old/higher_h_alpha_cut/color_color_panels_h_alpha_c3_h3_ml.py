...
for index in range(0, 20):
    ...
    h_alpha_coverage = (h_alpha_intensity_ml_3 > 3) & (hii_reg_ml_3 > 0)
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h3_ml_1.png', bbox_inches='tight', dpi=300)
# fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h3_ml_1.pdf', bbox_inches='tight', dpi=300)
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h3_ml_2.png', bbox_inches='tight', dpi=300)
# fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h3_ml_2.pdf', bbox_inches='tight', dpi=300)
