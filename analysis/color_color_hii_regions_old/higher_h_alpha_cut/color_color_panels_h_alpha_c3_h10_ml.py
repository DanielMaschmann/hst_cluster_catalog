...
for index in range(0, 20):
    ...
    h_alpha_intensity_ml_3 = np.zeros(len(color_vi_ml_3))
    ...
    h_alpha_coverage = (h_alpha_intensity_ml_3 > 10) & (hii_reg_ml_3 > 0)


    good_colors = (color_vi_ml_3 > -1.5) & (color_vi_ml_3 < 2.5) & (color_ub_ml_3 > -3) & (color_ub_ml_3 < 1.5)

    contours(ax=ax[row_index, col_index], x=color_vi_ml_3[good_colors], y=color_ub_ml_3[good_colors], levels=None)
    ...
    ax[row_index, col_index].scatter(color_vi_ml_3[(cluster_class_ml_3 == 3) & ~h_alpha_coverage],
                                     color_ub_ml_3[(cluster_class_ml_3 == 3) & ~h_alpha_coverage],
                                     c='silver', s=10)

    ax[row_index, col_index].scatter(color_vi_ml_3[(cluster_class_ml_3 == 3) & h_alpha_coverage],
                                     color_ub_ml_3[(cluster_class_ml_3 == 3) & h_alpha_coverage],
                                     c=h_alpha_intensity_ml_3[(cluster_class_ml_3 == 3) & h_alpha_coverage],
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h10_ml_1.png', bbox_inches='tight', dpi=300)
# fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h10_ml_1.pdf', bbox_inches='tight', dpi=300)
...
fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h10_ml_2.png', bbox_inches='tight', dpi=300)
# fig.savefig('plot_output/ub_vi_h_alpha_panel_c3_h10_ml_2.pdf', bbox_inches='tight', dpi=300)
