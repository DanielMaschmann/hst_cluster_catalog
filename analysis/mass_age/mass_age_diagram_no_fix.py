...
fig_hum.savefig('plot_output/age_m_star_hum_1_no_fix.png', bbox_inches='tight', dpi=300)
# fig_hum.savefig('plot_output/age_m_star_hum_1.pdf', bbox_inches='tight', dpi=300)

fig_ml.subplots_adjust(wspace=0, hspace=0)
fig_ml.savefig('plot_output/age_m_star_ml_1_no_fix.png', bbox_inches='tight', dpi=300)
...
fig_hum.subplots_adjust(wspace=0, hspace=0)
fig_hum.savefig('plot_output/age_m_star_hum_2_no_fix.png', bbox_inches='tight', dpi=300)
# fig_hum.savefig('plot_output/age_m_star_hum_2.pdf', bbox_inches='tight', dpi=300)

fig_ml.subplots_adjust(wspace=0, hspace=0)
fig_ml.savefig('plot_output/age_m_star_ml_2_no_fix.png', bbox_inches='tight', dpi=300)
