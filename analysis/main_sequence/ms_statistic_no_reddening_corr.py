...
for index in range(len(target_list)):
    ...
    mask_gc_hum = in_hull_gc_hum * detectable_hum
    mask_cascade_hum = in_hull_cascade_hum * detectable_hum
    mask_young_hum = (in_hull_young_hum * detectable_hum * np.invert(in_hull_cascade_hum))
    mask_no_class_hum = (np.invert(in_hull_gc_hum + in_hull_cascade_hum + in_hull_young_hum) * detectable_hum)

    mask_gc_ml = in_hull_gc_ml * detectable_ml
    mask_cascade_ml = in_hull_cascade_ml * detectable_ml
    mask_young_ml = (in_hull_young_ml * detectable_ml * np.invert(in_hull_cascade_ml))
...
ax[0, 0].scatter(delta_ms_list[mask_close], frac_young_list_hum[mask_close], s=200, color='tab:blue')
ax[0, 1].scatter(delta_ms_list[mask_close], frac_cascade_list_hum[mask_close], s=200, color='tab:green')
ax[0, 2].scatter(delta_ms_list[mask_close], frac_gc_list_hum[mask_close], s=200, color='tab:red')
ax[0, 3].scatter(delta_ms_list[mask_close], frac_no_class_list_hum[mask_close], s=200, color='tab:gray')

ax[0, 0].scatter(delta_ms_list[np.invert(mask_close)], frac_young_list_hum[np.invert(mask_close)], s=200, linewidth=4, facecolor='None', color='tab:blue')
ax[0, 1].scatter(delta_ms_list[np.invert(mask_close)], frac_cascade_list_hum[np.invert(mask_close)], s=200, linewidth=4, facecolor='None', color='tab:green')
ax[0, 2].scatter(delta_ms_list[np.invert(mask_close)], frac_gc_list_hum[np.invert(mask_close)], s=200, linewidth=4, facecolor='None', color='tab:red')
ax[0, 3].scatter(delta_ms_list[np.invert(mask_close)], frac_no_class_list_hum[np.invert(mask_close)], s=200, linewidth=4, facecolor='None', color='tab:gray')



ax[1, 0].scatter(delta_ms_list[mask_close], frac_young_list_ml[mask_close], s=200, color='tab:blue')
ax[1, 1].scatter(delta_ms_list[mask_close], frac_cascade_list_ml[mask_close], s=200, color='tab:green')
ax[1, 2].scatter(delta_ms_list[mask_close], frac_gc_list_ml[mask_close], s=200, color='tab:red')
ax[1, 3].scatter(delta_ms_list[mask_close], frac_no_class_list_ml[mask_close], s=200, color='tab:gray')

ax[1, 0].scatter(delta_ms_list[np.invert(mask_close)], frac_young_list_ml[np.invert(mask_close)], s=200, linewidth=4, facecolor='None', color='tab:blue')
ax[1, 1].scatter(delta_ms_list[np.invert(mask_close)], frac_cascade_list_ml[np.invert(mask_close)], s=200, linewidth=4, facecolor='None', color='tab:green')
ax[1, 2].scatter(delta_ms_list[np.invert(mask_close)], frac_gc_list_ml[np.invert(mask_close)], s=200, linewidth=4, facecolor='None', color='tab:red')
ax[1, 3].scatter(delta_ms_list[np.invert(mask_close)], frac_no_class_list_ml[np.invert(mask_close)], s=200, linewidth=4, facecolor='None', color='tab:gray')
...
# plt.tight_layout()
fig.savefig('plot_output/ms_stats_no_red_corr.png')
# fig.savefig('plot_output/ms_stats.pdf')
