...
\keywords{galaxies: star formation -- galaxies: star clusters: general}
...
%An approach employing both human and machine learning classifications was chosen for four basic reasons: (1) as noted, the large number of candidate clusters makes it prohibitive to classify them all manually, (2) human classification is not fully objective, (3) ML classification uses all five HST bands simultaneously, and (4) a training set is needed anyway to ``teach" the machine learning\footnote{An alternative approach could be to use synthetic clusters for training, but this opens the possibility of not fully capturing the true complexity of the population in terms of morphology (e.g. asymmetry, presence and spatial distribution of multiple peaks). We prefer, at present, to preserve a closer link to the data.}. In principle, it might be hoped that the agreement between human and ML classification would be so robust that the we can rely entirely on the ML catalog once it is built. While the current state of the art is quite promising (especially for C1+C2), we are not yet at a stage where  ML classification can be used blindly - care must be taken.

%If all galaxies in our sample were at the same distance, had similar levels of internal crowding, the same morphologies, the same levels of foreground and background contamination, training a machine learning classification program would be a much easier business. Reality is more complex than such an ideal scenario.  For all these reasons and more, caution is necessary when using the current generation of machine learning classifications. Machine learning classifications will continue to improve (e.g., see future plans in Whitmore et al, 2021 and Hannon 2023), but the subject is still in its infancy.
...
%
\begin{figure}
\includegraphics[width=0.45\textwidth]{figures/n_cluster_ssfr.pdf}
...
In general, the number of clusters and associations found in each galaxy increases with the sSFR.  Further analysis of the variation in cluster populations with sSFR is provided in Section 4.5.
...
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/v_mag.pdf}
...
%
\begin{figure} 
\includegraphics[width=0.5\textwidth]{figures/abs_v_mag_hist.pdf}
...
In the upper left panel of Figure~\ref{fig:mag_mstar}, the galaxies where the human classified sample is far shallower are indicated with open circles, consistent with the annotation provided in the Figure~\ref{fig:v_mag_panel} histograms. In Fig.~\ref{fig:ML12_brightestMV} we present a montage showing the brightest cluster in each of our targets.  These rather luminous clusters are almost all very young (1--3~Myr), though a few middle-age objects and one globular cluster (in NGC\,2775) are also shown.
...
In terms of stellar mass, we find median stellar masses of $\log(M_*/M_{\odot}) = 3.8$ and $4.2$ for ML and human clusters, respectively, at distances $<14~{\rm Mpc}$. For the more distant clusters ($>14~{\rm Mpc}$) we find median $\log(M_*/M_{\odot}) = 4.3$ and $4.5$. %The stellar masses are computed in Paper~II.
...
\begin{figure*}
\includegraphics[width=\textwidth]{figures/mag_mstar.pdf}
...
%
\begin{figure*}
\includegraphics[width=\textwidth]{figures/ML12_brightest.png}
...
%\citep[e.g.,][]{chandar_luminosity_2010, adamo_legacy_2017, larson_multi-scale_2022}. 
...
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/cc_compare.pdf}
...
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/uncert_reg_c12.pdf}
...
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/ub_vi_compare_density.pdf}
...
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/cc_mass_cut.pdf}
...
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/contour_maps_ubvi.pdf}
...
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/contour_maps_nuvbvi.pdf}
...
\begin{figure*}
\includegraphics[width=\textwidth]{figures/ub_vi_panel_1.pdf}
...
%
\begin{figure*}
\includegraphics[width=\textwidth]{figures/ub_vi_panel_2.pdf}
 \caption{Continuation of Figure~\ref{fig:ub_vi_1}.}
 \label{fig:ub_vi_2}
\end{figure*}
\section{Color-Color Diagrams: Individual galaxies} 
%\subsection{Relation to galactic star formation properties}\label{ssect:cc_sf}
%
...
\includegraphics[width=\textwidth]{figures/ms_cc.pdf}
 ...
 The essence of this figure is the connection between star formation activity and the cluster population of all PHANGS-HST galaxies. As discussed in the text, the star formation rates are sensitive to timescales of $< 100\,{\rm Myr}$ and therefore the relative fractions of MAS clusters correlate with the relative position on the MS as shown in Figure~\ref{fig:ms_stats}.}
 \label{fig:ms}
\end{figure*}
%
\begin{figure*}
\includegraphics[width=\textwidth]{figures/ms_stats.pdf}
...
\input{tables/delta_ms_morph_new}
% young populations
...
A linear fit to this correlation yields the same slope of $0.14$ for both human and ML classified cluster samples. This behaviour may be expected since the SFR values are the average of the star formation history of $ < 100\,{\rm Myr}$, and the MAP holds the largest fraction of such clusters. %This not only confirms the robustness of the main regions, we selected through color-color diagrams but further underlines the diagnostic power of color-color diagrams.
...
%
\begin{figure} 
\includegraphics[width=0.48\textwidth]{figures/molecular_gas_stats_snr_6.pdf}
...
This work is based on observations made with the NASA/ESA Hubble Space Telescope, obtained at the Space Telescope Science Institute, which is operated by the Association of Universities for Research in Astronomy, Inc., under NASA contract NAS 5-26555. These observations are associated with program \#13364. 


\section*{Data Availability}
The PHANGS--HST star cluster catalogs will be made publicly available through the Mikulski Archive for Space Telescopes (MAST) December 2023. 
...
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_0.pdf}
 ...
 In order to highlight the relation between young clusters and molecular gas, with magenta lines, we overlay the ALMA CO(2-1) intensity contours on the YCL distribution maps.
...
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_1.pdf}
 \caption{Continuation of Figure\,\ref{fig:spatial_dist}}
 \label{fig:spatial_dist_1}
\end{figure*}
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_2.pdf}
 \caption{Continuation of Figure\,\ref{fig:spatial_dist}}
 \label{fig:spatial_dist_2}
\end{figure*}
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_3.pdf}
 \caption{Continuation of Figure\,\ref{fig:spatial_dist}}
 \label{fig:spatial_dist_3}
\end{figure*}
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_4.pdf}
 \caption{Continuation of Figure\,\ref{fig:spatial_dist}}
 \label{fig:spatial_dist_4}
\end{figure*}
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_5.pdf}
 \caption{Continuation of Figure\,\ref{fig:spatial_dist}}
 \label{fig:spatial_dist_5}
\end{figure*}
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_6.pdf}
...
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_7.pdf}
 \caption{Continuation of Figure\,\ref{fig:spatial_dist}}
 \label{fig:spatial_dist_7}
\end{figure*}
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_8.pdf}
 \caption{Continuation of Figure\,\ref{fig:spatial_dist}}
 \label{fig:spatial_dist_8}
\end{figure*}
%
\begin{figure*} 
\includegraphics[width=\textwidth]{figures/spatial_dist/overview_panel_9.pdf}
 \caption{Continuation of Figure\,\ref{fig:spatial_dist}}
