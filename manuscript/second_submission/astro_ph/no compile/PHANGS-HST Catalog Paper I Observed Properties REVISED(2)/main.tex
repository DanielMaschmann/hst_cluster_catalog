...
Our large sample of $\sim$100,000 star clusters and associations combined across the 38 galaxies of the PHANGS-HST sample reveals that the distribution in the U-B vs. V-I color-color diagram %In \citet{lee23ubvi}, we showed that the distribution 
...
%\begin{itemize}
%    \item {Young Cluster Locus (YCL)} (blue) 
%    \item {Middle-Age Plume (MAP)} (green) 
%    \item {Old Globular Cluster Clump (OGC)} (red)  
%\end{itemize}
