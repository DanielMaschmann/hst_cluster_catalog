...
% prior version (name) := main.tex 
% prior version (timestamp:iso) := 2024-03-07 12:20:16.000000000
% prior version (hash:MD5) := 95368933f84cb95bce573597ba99d2e5 
...
\newcommand{\ASCL}{\affil{Astrophysics Source Code Library, Michigan Technological University, 1400 Townsend Drive, Houghton, MI 49931}}
...
\newcommand{\UNAM}{\affil{Instituto de Astronom\'ia, Universidad Nacional Aut\'onoma de M\'exico, Unidad Acad\'emica en Ensenada, Km 103 Carr. Tijuana-Ensenada, Ensenada, B.C.,
C.P. 22860, M\'exico}}
...
\newcommand{\PLATA}{\affil{Instituto de Astrof\'{\i}sica de La Plata, CONICET--UNLP, Paseo del Bosque S/N, B1900FWA La Plata, Argentina }}
...
\author[0000-0001-7130-2880]{Leonardo \'Ubeda}
\STScI
...
\author[0009-0009-9148-2159]{Qiushi Tian}
\wesleyan
...
\dataset[doi:10.17909/jray-9798]{https://doi.org/10.17909/jray-9798}.

\software{DOLPHOT \citep[v2.0][]{dolphin_dolphot_2016}, CIGALE \citep{burgarella_star_2005,noll_analysis_2009,boquien_cigale_2019}}
...
\includegraphics[width=\textwidth]{overview_panel_0.pdf}
 ...
 \textbf{In this figure and the online Figure set}, we show the spatial cluster distribution for all PHANGS--HST galaxies sorted by decreasing $\Delta$MS values (see Figure\,\ref{fig:ms}).
 \textbf{The complete figure set (10 images) is available in the online journal.}}
